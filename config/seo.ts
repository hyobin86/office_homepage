...
export const PAGE_SEO = {
  ...
  'services/service1': {
    ...
    description: '보험 영업조직 관리를 위한 GA 통합 운영 시스템입니다. 배정 DB 관리, 상담/계약관리, 교육/영업 평가, 수수료 관리, 위촉지원, 인사관리 등 영업지원 솔루션을 제공합니다.',
    keywords: 'GA시스템, 통합운영시스템, 영업지원솔루션, 보험영업관리, 배정DB관리, 계약관리, 수수료관리, 위촉지원, 인사관리, 핀게이트'
  },
  'services/service2': {
